...
public class LastSlideAction implements ActionListener {
    ...
    public void lastSlide() {
        ...
        if (currentTopComponent != null) {
            int lastSlide = currentTopComponent.getPresentation().getSlides().size() - 1;
            currentTopComponent.setSelectedSlideIndex(lastSlide);
        }
    }
}
